...
parser.add_argument('--checkpoint_path', type=str, default='../model/model_best.pt', help='path to store/load checkpoints')
...
parser.add_argument('--gpu', type=int, default=1, help='gpu device id (optional)')
